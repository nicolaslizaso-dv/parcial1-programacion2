...
<div class="container py-5 text-center fade-in-up">
    <div class="row justify-content-center">
        <div class="col-md-8 bg-white p-5 border shadow-sm">
            <h2 class="display-5 text-primary mb-4 text-uppercase fw-bold">¡Compra Confirmada!</h2>
            ...
            <a href="index.php?sec=catalogo" class="btn btn-outline-primary fw-bold text-uppercase py-3 px-5">Volver al Catálogo</a>
        </div>
    </div>
</div>